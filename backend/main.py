...
def seed_database():
    ...
    with Session(engine) as session:
        ...
        items = [
            ...
            Product(name="PhoneHub Edge Z", category="phone", price=64999.00, stock_quantity=14, description="Curved display smartphone with ceramic back.", specs="6.5 inch Curved OLED, 256GB, 4700mAh", image_url="https://images.unsplash.com/photo-1574944985070-8f30c4397e3c?w=500&auto=format&fit=crop"),
